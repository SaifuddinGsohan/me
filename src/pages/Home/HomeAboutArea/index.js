...
const HomeAboutArea = () => {
    ...
    return ( <
        ...
        Grid container justify = "center"
        style = {
            { paddingTop: "2rem", paddingBottom: "0rem" } } >
        <
        Grid item >
        <
        img src = { logo }
        ...
        Grid container justify = "center"
        style = {
            { paddingTop: "0rem", paddingBottom: "2rem" } } >
        <
        Grid item >
        <
        Typography align = "center"
        ...
        variant = "subtitle1"
        style = {
            { maxWidth: "20rem", paddingTop: "2rem" } } >
